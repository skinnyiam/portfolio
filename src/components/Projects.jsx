...
const Projects = () => {
  return (
    <>
      <div className=" h-[91vh] sm:pt-[0px] w-full flex justify-center">
        <div>
          <h1 className="text-emerald-400 sm:pt-[30px]  sm:text-3xl  font-bold flex justify-center">
            PROJECTS
          </h1>
          <div data-aos="zoom-in-down" className=" flex sm:mt-[20px] ">
            <div className="sm:inline hidden pr-[40px]">
              <img
                src={require("../asset/movie.png")}
                alt=""
            ...
            <div>
              ...
              <div className="mt-[35px]">
                <button
                  className="w-[120px] h-[50px] text-black-400 font-bold text-2xl bg-green-700 m-8 rounded p-[3px] "
                  href="https://movies-search-karo.herokuapp.com/"
                >
                  WEBSITE
                </button>
                <a
                  className="w-[120px] h-[50px] text-white  text-2xl font-bold border-green-400 border-2 mt-[20px] rounded"
