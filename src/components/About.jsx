      ...
      >
        ...
        <ul className="sm:flex-row">
          ...
          <div className="sm:h-[34px]  sm:w-[385px]  bg-white sm:ml-[39px]  border-solid rounded-2xl  ">
            <div className="sm:h-[34px]  sm:w-[325px]   bg-red-500 border-solid rounded-2xl"></div>
          </div>
          <li className="text-green-600 sm:text-2xl text-2xl font-bold">
            React
          </li>
          <div className="sm:h-[34px]  sm:w-[385px]  bg-white sm:ml-[39px]  border-solid rounded-2xl">
            <div className="sm:h-[34px]  sm:w-[300px]  bg-green-600 border-solid rounded-2xl"></div>
          </div>
          <li className="text-fuchsia-700 sm:text-2xl text-2xl font-bold">
            Node Js
          </li>
          <div className="sm:h-[34px] sm:w-[385px]  bg-white sm:ml-[39px]  border-solid rounded-2xl">
            <div className="sm:h-[34px]  sm:w-[285px]  bg-fuchsia-700 border-solid rounded-2xl"></div>
          </div>
          <li className="text-amber-500 sm:text-2xl text-2xl font-bold">
            Javascript
          </li>
          <div className="sm:h-[34px]  sm:w-[385px]  bg-white sm:ml-[39px]  border-solid rounded-2xl">
            <div className="sm:h-[34px]  sm:w-[335px]  bg-amber-500 border-solid rounded-2xl"></div>
          </div>
          <li className="text-sky-500 sm:text-2xl text-2xl font-bold">
            MongoDB
          </li>
          <div className="sm:h-[34px]  sm:w-[385px]  bg-white sm:ml-[39px]  border-solid rounded-2xl">
            <div className="sm:h-[34px]  sm:w-[205px]  bg-sky-700 border-solid rounded-2xl"></div>
          </div>
        </ul>
        <p className="pt-[0px] text-2xl  font-bold text-green-400">
          {" "}
          I also do Competetive Programming to improve my problem solving skills{" "}
        </p>

        <p className=" sm:text-xl text-xl font-bold text-green-400">
          Check out my ratings here:
        </p>
        <div className="pt-[3px]">
          <button className="bg-white mr-[29px]">
            <a
        ...
        <div className="pt-[20px]  h-[100px] ">
          <h1 className="text-red-700 sm:text-3xl font-bold">HOBBIES</h1>
          <p className="text-teal-400 sm:text-2xl ">
            I play guitar and in the free time i play chess.
          </p>
          <p className="text-teal-400 text-2xl  ">
            Check out my{" "}
            <a
              className=" decoration-teal-600 decoration-2 underline underline-offset-4"
